...
public class LogPlot extends JFrame {
	
	Vector joins;
	int count;
	Vector readings;
	Vector readingsConv;
	LogPlotCanvas canvas;
	
	public LogPlot(String logFile[]){
		...
		canvas = new LogPlotCanvas(readingsConv,joins);		
