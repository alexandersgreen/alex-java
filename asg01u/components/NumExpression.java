...
public abstract class NumExpression extends Expression implements Cloneable{
	
	public NumExpression(String font, int attrib, int size, Color col,boolean root){
