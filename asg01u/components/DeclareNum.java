...
public class DeclareNum extends asg01u.components.NumExpression{
	...
	public DeclareNum(String font, int attrib, int size, Color col,String keyString,asg01u.components.NumExpression in,boolean root, HashMap hm){
			super(font,attrib,size,col,root);
			variables = hm;
			exp = in;
			variables.put(keyString,exp);
			System.out.println("DeclareNum ("+keyString+") created");
