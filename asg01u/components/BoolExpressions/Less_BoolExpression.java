...
public class Less_BoolExpression extends asg01u.components.BoolExpression{

	asg01u.components.NumExpression exp1;
	asg01u.components.NumExpression exp2;
	JTextArea less;
	
	public Less_BoolExpression(String font, int attrib, int size, Color col,asg01u.components.NumExpression in1,asg01u.components.NumExpression in2,boolean root){
			...
			less.setAlignmentX(Component.CENTER_ALIGNMENT);
			less.setAlignmentY(Component.CENTER_ALIGNMENT);
			less.setEditable(false);
			less.setMaximumSize(less.getPreferredSize());
		...
		public void setTheFont(String font, int attrib, int size, Color col, int what){
			...
			less.setFont(new Font(fontName,fontAttributes,fontSize));
			less.setForeground(colour);
			less.setMaximumSize(less.getPreferredSize());
			recreate();
			}
	...
	public String outputString(){
		...
		output = "<Less_BoolExpression>\n";
		output = output + "  <LessExpression1>\n";
			output = output + exp1.outputString();
		output = output + "  </LessExpression1>\n";
		output = output + "  <LessExpression2>\n";
		...
		output = output + "\n    </blue>\n";
		output = output + "  </colour>\n";
		output = output + "</Less_BoolExpression>\n";
		return output;	
	}
	...
	public Object clone() throws CloneNotSupportedException {
		return new Less_BoolExpression(new String(fontName),fontAttributes,fontSize,new Color(colour.getRed(),colour.getGreen(),colour.getBlue()),(NumExpression) exp1.clone(),(NumExpression) exp2.clone(),true);
	}
}